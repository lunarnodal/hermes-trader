...
- event_type: exactly one of "earnings", "macro", "geopolitical", "regulatory", "merger_acquisition", "merger_arbitrage", "ipo", "product", "leadership_transition", "corporate_governance", "ai_infrastructure", "sec_filing", "commodity_shortage", "supply_disruption", "market_trend", "sp500_component", "analyst_rating", "technical_signal", "other"
  ...
  market_movers: Articles explaining why a specific stock is moving significantly today. Pattern: "Why is [TICKER] stock sliding/surging/falling/plunging/rising today?" or "[COMPANY] shares [up/down/surge/plunge] on [catalyst]". Examples: "Why is Interactive Brokers stock sliding today?" -> market_movers; "Why is Okta stock surging today?" -> market_movers. EXCLUDE: general index moves -> macro; earnings-driven moves -> earnings.
  conference_presentation: Company management presenting at an investor or industry conference. Pattern: "[COMPANY] at [FIRM] [year] [sector] Conference" or "[COMPANY] Presents at [CONFERENCE]". Examples: "Medtronic Presents at Wells Fargo Healthcare Conference" -> conference_presentation; "onsemi at Deutsche Bank Technology Conference" -> conference_presentation. Sentiment is neutral unless specific guidance or news is disclosed.
